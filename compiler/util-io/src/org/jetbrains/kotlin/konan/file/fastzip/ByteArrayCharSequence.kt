...
internal class ByteArrayCharSequence(
    ...
    override fun hashCode(): Int {
        error("Do not try computing hashCode on ByteArrayCharSequence")
    }
    ...
    override fun get(index: Int): Char = (bytes[index + start].toInt() and 0xFF).toChar()
    ...
    override fun toString(): String {
        ...
        for (i in 0 until length) {
            chars[i] = (bytes[i + start].toInt() and 0xFF).toChar()
        }
        return String(chars)
    }
}
