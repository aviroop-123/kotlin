...
object KlibConfigurationKeysContainer : KeysContainer("org.jetbrains.kotlin.config", "KlibConfigurationKeys") {
    ...
    val CUSTOM_KLIB_ABI_VERSION by key<KotlinAbiVersion>(throwOnNull = false)
    ...
    val USE_FAST_KLIB_FILE_SYSTEM by key<Boolean>("Use fast memory-mapped file system for klib reading.")
}
